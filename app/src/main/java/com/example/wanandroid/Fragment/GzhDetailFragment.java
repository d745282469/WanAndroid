...
public class GzhDetailFragment extends Fragment {
    private static final String TAG = "GzhDetailFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        GetGzhArticle(projectChapterId, currentPage);
        ...
        sv_nested.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView view, int x, int y, int oldX, int oldY) {
                if (y == view.getChildAt(0).getMeasuredHeight() - view.getMeasuredHeight()) {
                    //滑动到底部
                    GetGzhArticle(projectChapterId, currentPage + 1);
                }
            }
        });
        ...
        WanApi.GetGzhArticle(id, page, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                ...
                if (object.get("errorCode").getAsInt() != 0) {
                    Toast.makeText(context, "获取公众号文章文章失败：" + object.get("errorMsg").getAsString(), Toast.LENGTH_SHORT).show();
                } else {
